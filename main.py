...
global max_volume, min_volume, continuous_decay, change_magnitude, log_enabled, current_volume
max_volume: int = args.max
min_volume: int= args.min
continuous_decay: float = args.decay
change_magnitude: float = args.magnitude
